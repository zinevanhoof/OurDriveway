...
-- ─── booking ────────────────────────────────────────────────────────────────
-- spot_id / host_id are plain uuids: the authoritative spot lives in spot-service's
-- database. host_id is denormalized in at create time so a booking can be scoped to
