...
<template>
    <DetailLayout title="Profile" @close="router.back()">
        <template #main>
            <!-- Tighter than the layout's own `space-y-4`: these are stacked rows of one
                 list, not separate sections. -->
            <div class="space-y-2">
                ...
                <Surface size="none">
                    <Surface as="button" variant="none" orientation="horizontal" type="button"
                        class="w-full gap-3 text-left" @click="router.push({ name: 'profile-edit' })">
                        <IconBox>
                            <UserRound />
                        </IconBox>
                    ...
                    <Separator />
                    <Surface as="button" variant="none" orientation="horizontal" type="button"
                        class="w-full gap-3 text-left" @click="router.push({ name: 'profile-password' })">
                        <IconBox>
                            <Lock />
                        </IconBox>
                ...
                <Surface size="none">
                    <Surface as="button" variant="none" orientation="horizontal" type="button"
                        class="w-full gap-3 text-left" @click="confirmOpen = true">
                        <IconBox>
