...
export const itemVariants = cva(
  "[a]:hover:bg-muted rounded-md border text-sm group/item flex w-full flex-wrap items-center transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/15 [a]:transition-colors",
  {
    variants: {
      variant: {
